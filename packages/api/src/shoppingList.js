...
//
// Batch goes back to 1 with the flag, as it does when one Recipe is deselected on its own: a Batch is
// how many times a Recipe is being made on this trip, and after the trip there is no trip.
